...
export function Footer() {
  return (
    <footer
      className="bg-volcanic-gray-dark text-gray-300"
          ...
          <div className="mt-10 lg:mt-0">
            ...
            <form className="mt-6 sm:flex sm:max-w-md">
              ...
              <input
                ...
                autoComplete="email"
                className="w-full min-w-0 appearance-none rounded-md border-0 bg-white/5 px-3 py-1.5 text-base text-white shadow-sm ring-1 ring-inset ring-white/10 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-ocean-blue sm:w-64 sm:text-sm sm:leading-6 xl:w-full"
              />
