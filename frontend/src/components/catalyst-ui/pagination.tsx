  ...
  return (
    <Button
      ...
      className={clsx(
        ...
        current && 'before:bg-zinc-950/5 dark:before:bg-background-primary/10'
      )}
    >
...
export function PaginationGap({
  ...
  return (
    <span
      aria-hidden="true"
      {...props}
      className={clsx(className, 'w-9 text-center text-sm/6 font-semibold text-zinc-950 select-none dark:text-text-primary')}
    >
      {children}
    </span>
  )
