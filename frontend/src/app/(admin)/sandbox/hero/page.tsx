...
// --- Brand System Colors & Tokens ---
// Ocean Blue: #0E4C75
// Bougainvillea Pink: #C02669
// Basalt 900: #0F172A
// Mist 50: #F8FAFC
...
// 3. Sticky Navigation (Transforming from Pill to Bar)
const StickyNav = () => {
  ...
  useEffect(() => {
    const observer = new IntersectionObserver(
      ([entry]) => {
        // When the sentinel (placed just above nav) scrolls out of view to the top,
        // it means the nav has hit the top edge.
  ...
  return (
    <>
      ...
      {/* Sticky Container 
        ...
        - Transition on padding: Shrinks gap when stuck to create "docked" look
      */}
      <div
      ...
      >
        <div
          className={`mx-auto flex h-16 items-center justify-between border-white/10 bg-[#0F172A]/90 shadow-2xl backdrop-blur-xl transition-all duration-500 ease-in-out ${
            isStuck
              ? "max-w-full rounded-none border-b px-6" // Stuck state: Full width, square corners
              : "max-w-6xl rounded-full border px-4" // Floating state: Pill shape
          } `}
        >
          {/* Left: Logo */}
...
// 6. Content Section (Solid background to cover fixed image)
          ...
          >
            ...
            <div className="p-6">
              ...
              <h3 className="mb-2 font-serif text-xl font-bold transition-colors group-hover:text-[#0E4C75]">
                The Fisherman's Tale of Fajã d'Água
              </h3>
  ...
  return (
    <div className="relative min-h-screen font-sans selection:bg-[#C02669]/30 selection:text-white">
      ...
      <div className="relative z-10 flex flex-col">
        ...
        {/* Sticky Nav - Sits below hero content naturally, sticks to top on scroll */}
        <StickyNav />
