...
const EventCard = ({ event }: { event: EventItem }) => (
  <div className="border-border-secondary flex overflow-hidden rounded-xl border bg-white shadow-sm transition-shadow hover:shadow-md">
    <div className="bg-ocean-blue/5 border-border-secondary flex w-20 flex-col items-center justify-center border-r p-2 text-center">
...
export default function LandingPage() {
  ...
  return (
    <div className="bg-off-white selection:bg-ocean-blue min-h-screen font-sans selection:text-white">
      ...
      {/* 3. NEW SECTION: Living Culture (Events + Language) */}
          ...
          <div className="flex flex-col gap-12 lg:flex-row">
            ...
            <div className="lg:w-2/3">
              ...
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                ...
                <Link
                  href="/events"
                  className="border-border-secondary text-text-secondary hover:text-ocean-blue hover:border-ocean-blue group flex items-center justify-center rounded-xl border-2 border-dashed p-6 transition-colors"
                >
            ...
            {/* Right: Kriolu Corner (Language) & Weather Widget */}
            <div className="flex flex-col gap-6 lg:w-1/3">
              {/* Proverb Card */}
              <div className="bg-ocean-blue relative overflow-hidden rounded-2xl p-8 text-white shadow-lg">
                <div className="bg-sunny-yellow absolute top-0 right-0 -mt-4 -mr-4 h-24 w-24 rounded-full opacity-20 blur-xl"></div>
              ...
              {/* Mini Weather/Ferry Widget */}
              <div className="border-border-secondary flex items-center justify-between rounded-2xl border bg-white p-6 shadow-sm">
                <div>
      ...
      {/* 5. COMMUNITY STATS */}
      <section className="border-border-secondary border-y bg-white py-20">
        <div className="container mx-auto px-4 md:px-6">
          <SectionHeader
