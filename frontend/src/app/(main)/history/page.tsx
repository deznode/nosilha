...
const historicalSections = [
  ...
  },
  {
    ...
    image_courtesy: "the New Bedford Whaling Museum",
  },
];
          ...
          <section className="bg-background-primary border-border-primary mt-16 rounded-lg border p-8 shadow-sm">
            <div className="mx-auto max-w-4xl">
              ...
              <p className="text-text-secondary mb-6">
                ...
                island in the Cape Verde archipelago, yet it has produced a
                cultural and political influence disproportionate to its size.
                This phenomenon stems from a defining moment in 1680 when a
                catastrophic eruption of Pico do Fogo forced thousands of
                refugees from the neighboring island to seek sanctuary on
                Brava&apos;s shores. Unlike most colonial settlements founded
                through conquest, Brava&apos;s society was forged through
                collective compassion and survival.
              </p>
              <p className="text-text-secondary">
                ...
                eventually establishing the &quot;Brava Packet Trade&quot; that
                would bind families across the Atlantic for generations. This
                maritime connection gave birth to the profound cultural
            ...
            <div className="mb-8 grid gap-8 lg:grid-cols-2">
              <div>
                ...
                <p className="text-text-secondary mb-4">
                  ...
                  characterizes the island today. Though no historical eruptions
                  are recorded, persistent seismic activity and youthful
                  volcanic features mean Brava cannot be considered extinct.
                </p>
                <p className="text-text-secondary">
                  This geological restlessness creates a landscape of precarious
                  beauty—the very ground beneath one&apos;s feet is
                  untrustworthy, perhaps contributing to the cultural phenomenon
                  of <em>sodade</em>, that deep melancholy and longing for
                  stability.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-text-secondary mb-4">
                  Portuguese explorer Diogo Afonso discovered uninhabited Brava
                  in 1462, but permanent settlement didn&apos;t begin until
                  around 1620, with only a few hundred fishermen from Madeira
                  and the Azores. The island&apos;s destiny changed forever in
                  1680 when Mount Fogo&apos;s catastrophic eruption engulfed the
                ...
                <p className="text-text-secondary">
                  ...
                  capital, Vila Nova Sintra, around 1700, nestled securely at
                  over 500 meters elevation.
                </p>
              </div>
            </div>
              ...
              <div className="grid items-center gap-8 lg:grid-cols-2">
                <div>
                  ...
                  <p className="text-text-secondary mb-4">
                    ...
                    Pacific hunting grounds. Brava&apos;s sheltered harbors at
                    Fajã de Água and Furna became essential provisioning stops,
                    where vessels could replenish fresh water, supplies,
                    and—crucially—crew.
                  </p>
                  <p className="text-text-secondary mb-4">
                    This maritime traffic created an unintentional engine of
                    globalization that permanently broke Brava&apos;s isolation.
                    Yankee captains, recognizing exceptional maritime skills
                    among local men, began systematic recruitment. For Bravans
                    facing recurring cycles of drought, famine, and poverty, a
                    berth on a whaleship offered wages and a chance at a new
                    life.
                  </p>
                  <p className="text-text-secondary">
                    This recruitment transformed Brava from an isolated
                    Portuguese colony into a transnational community, perceived
                    as more &quot;European&quot; and less &quot;African&quot;
                    than its neighbors due to these deep American connections.
                  </p>
                </div>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <div className="bg-background-primary border-border-primary rounded-lg border p-6 shadow-sm">
                ...
                <p className="text-text-secondary mb-3">
                  ...
                  transnational community, carrying passengers, mail, cargo, and
                  the emotional threads binding families across the Atlantic.
                </p>
                <ul className="text-text-secondary space-y-1 text-sm">
                  ...
                  <li>
                    • <strong>Valkyria:</strong> Known as the &quot;Queen of the
                    Cape Verde Packets&quot;
                  </li>
                  <li>
              ...
              <div className="bg-background-primary border-border-primary rounded-lg border p-6 shadow-sm">
                ...
                <p className="text-text-secondary text-sm">
                  This wasn&apos;t merely commerce—it was the vital circulatory
                  system of a community that existed simultaneously on both
                  sides of the Atlantic. The flow of people, money, goods, and
                  cultural exchange created an identity that was neither fully
          ...
          <section className="bg-background-primary border-border-primary mt-16 rounded-lg border p-8 shadow-sm">
            <div className="mb-8 text-center">
              ...
              <p className="text-text-secondary mb-6">
                ...
                contributions far exceed the island&apos;s small size, creating
                a legacy that defines Cape Verdean cultural identity
              </p>
              <Link
                href="/people"
            ...
            <div className="space-y-6">
              <div className="bg-background-primary border-border-primary flex items-start space-x-4 rounded-lg border p-6 shadow-sm">
                ...
                <div>
                  ...
                  <p className="text-text-secondary">
                    Brava Island is discovered by Portuguese navigators during
              ...
              <div className="bg-background-primary border-border-primary flex items-start space-x-4 rounded-lg border p-6 shadow-sm">
                ...
                <div>
                  ...
                  <p className="text-text-secondary">
                    Mount Fogo&apos;s catastrophic eruption forces a mass exodus
                    from the neighboring island. Brava, with its fertile valleys
                    and fresh water, becomes the primary sanctuary for refugees,
                    establishing the demographic foundation of its society
                    through an act of collective compassion rather than
                    conquest.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-background-primary border-border-primary flex items-start space-x-4 rounded-lg border p-6 shadow-sm">
                ...
                <div>
                  ...
                  <p className="text-text-secondary">
                    ...
                    Brava&apos;s relationship with the wider world for centuries
                    to come.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-background-primary border-border-primary flex items-start space-x-4 rounded-lg border p-6 shadow-sm">
                ...
                <div>
                  ...
                  <p className="text-text-secondary">
                    American whaling ships from New England begin using
                    Brava&apos;s sheltered harbors at Fajã de Água and Furna as
                    provisioning stops on trans-Atlantic routes to Pacific
                    hunting grounds. Impressed by Bravense maritime skills,
                    Yankee captains begin systematic recruitment, creating the
                    foundation for over a century of transnational community.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-background-primary border-border-primary flex items-start space-x-4 rounded-lg border p-6 shadow-sm">
                ...
                <div>
                  ...
                  <p className="text-text-secondary">
                    The &quot;Brava Packet Trade&quot; formalizes emigration
                    patterns, with ships carrying passengers, mail, and goods
                    between Brava and New England ports, creating a vital
                    transnational lifeline.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-background-primary border-border-primary flex items-start space-x-4 rounded-lg border p-6 shadow-sm">
                ...
                <div>
                  ...
                  <p className="text-text-secondary">
                    Birth of Cape Verde&apos;s most celebrated poet and
                    composer, who would transform the morna musical genre and
                    champion Crioulo as a literary language.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-background-primary border-border-primary flex items-start space-x-4 rounded-lg border p-6 shadow-sm">
                ...
                <div>
                  ...
                  <p className="text-text-secondary">
                    ...
                    internationalizes his voice. He founds &quot;A
                    Alvorada&quot; (Dawn), the first Portuguese-language
                    newspaper in the United States, and writes his most poignant
                    mornas about *sodade* and separation.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-background-primary border-border-primary flex items-start space-x-4 rounded-lg border p-6 shadow-sm">
                ...
                <div>
                  ...
                  <p className="text-text-secondary">
                    Publication of &quot;Mornas: Cantigas Crioulas,&quot;
                    Tavares&apos;s posthumous collection that becomes the
                    foundational text of Cape Verdean literature. His poem
                    &quot;Morna de Aguada&quot; later appears on the 2000 escudo
                    banknote alongside his portrait, cementing his status as the
                    nation&apos;s cultural patriarch.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-background-primary border-border-primary flex items-start space-x-4 rounded-lg border p-6 shadow-sm">
                ...
                <div>
                  ...
                  <p className="text-text-secondary">
                    Cape Verde gains independence from Portugal, with
                    Brava&apos;s cultural contributions—the morna, Crioulo
                    literature, and the concept of *sodade*—now recognized as
                    pillars of national identity. The island continues its role
                    as cultural beacon while maintaining its unique
              ...
              <div className="bg-background-primary border-border-primary flex items-start space-x-4 rounded-lg border p-6 shadow-sm">
                ...
                <div>
                  ...
                  <p className="text-text-secondary">
                    ...
                    the island&apos;s unique microclimate, while contemporary
                    artists like Vuca Pinheiro explicitly honor Eugénio Tavares,
                    and the diaspora continues producing leaders like District
          ...
          <section className="from-ocean-blue/10 to-valley-green/10 mt-16 rounded-lg bg-gradient-to-r p-8">
            ...
            <div className="grid gap-6 md:grid-cols-3">
              <div className="text-center">
                ...
                <p className="text-text-secondary text-sm">
                  Brava pioneered the definitive morna style—slow tempo (around
                  60 beats per minute), romantic themes, and accentuated
                  lyricism rooted in 19th-century Romanticism. Eugénio Tavares
                  transformed it &quot;from laughter to weeping,&quot; codifying{" "}
                  <em>sodade</em>
              ...
              <div className="text-center">
                ...
                <p className="text-text-secondary text-sm">
                  ...
                  identity and inspired generations of writers to celebrate
                  their distinct linguistic heritage.
                </p>
              </div>
            ...
            <div className="mb-8 grid gap-8 md:grid-cols-2">
              ...
              <div className="bg-background-primary border-border-primary rounded-lg border p-6 shadow-sm">
                ...
                <p className="text-text-secondary text-sm">
                  ...
                  Nova Sintra is on UNESCO&apos;s tentative list), and
