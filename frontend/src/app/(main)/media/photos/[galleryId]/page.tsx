...
const galleryData: Record<string, Gallery> = {
  "landscapes": {
    ...
    featured: true,
    culturalContext: "Brava's volcanic origins create some of Cape Verde's most spectacular scenery, with terraced valleys that have sustained our communities for centuries.",
    ...
    photos: [
      {
        ...
        date: "2024",
        description: "The early morning mist that earned Brava its lush reputation"
      },
      {
        ...
        date: "2024",
        description: "Traditional socos terraces that have fed our families for generations"
      },
      {
        ...
        date: "2024",
        description: "From our highest peak, the entire island and neighboring Fogo are visible"
      },
      {
        ...
        date: "2024",
        description: "Where our volcanic island rises directly from the deep Atlantic"
      },
      {
        ...
        location: "Cova Joana",
        date: "2024",
        description: "The ancient crater valley where hibiscus blooms year-round"
      },
      {
  ...
  "coastal": {
    ...
    featured: true,
    culturalContext: "Brava's coasts have been shaped by both volcanic activity and centuries of Atlantic weather, creating unique formations and natural harbors.",
    ...
    photos: [
      {
        ...
        date: "2024",
        description: "Volcanic rock pools where families have swum safely for generations"
      },
      {
        ...
        location: "Furna",
        date: "2024",
        description: "Our main harbor, perfectly sheltered within an ancient volcanic crater"
      },
      {
        ...
        date: "2024",
        description: "The daily rhythm of our fishing community continues ancient traditions"
      },
      {
        ...
        date: "2024",
        description: "Sheer volcanic cliffs that protect our northern settlements"
      },
      {
        ...
        date: "2024",
        description: "Evening light transforms our rocky shores into mirrors of gold"
      },
      {
        ...
        location: "Furna",
        date: "2024",
        description: "The tools of our maritime heritage, maintained by skilled hands"
      }
    ]
  },
  "cultural": {
    ...
    featured: true,
    culturalContext: "Brava's cultural traditions blend Portuguese Catholic heritage with African rhythms and American influences from our diaspora connections.",
    ...
    photos: [
      {
        ...
        date: "August 15, 2024",
        description: "Annual pilgrimage that has united our mountain communities for over 150 years"
      },
      {
        ...
        date: "2024",
        description: "Evening morna in our main square, where Eugénio Tavares once walked"
      },
      {
        ...
        location: "Furna harbor",
        date: "2024",
        description: "Blessing of the fishing fleet, honoring the patron saint of seafarers"
      },
      {
        ...
        date: "2024",
        description: "Preparing catchupa, our national dish that brings families together"
      },
      {
        ...
        location: "Nova Sintra",
        date: "June 24, 2024",
        description: "Our island's largest festival, centered around the replica of Columbus's ship"
      },
      {
  ...
  "architecture": {
    ...
    featured: false,
    culturalContext: "Brava's architecture reflects our global connections, with colonial Portuguese influences enhanced by diaspora prosperity from New England.",
    ...
    photos: [
      {
        ...
        location: "Nova Sintra",
        date: "2024",
        description: "Two-story colonial homes built by successful emigrants returning home"
      },
      {
        ...
        location: "Nova Sintra",
        date: "Built c. 1880",
        description: "Our main parish church, centerpiece of community life since the 19th century"
      },
      {
        ...
        date: "2024",
        description: "Simple island homes surrounded by the flowers that give us our name"
      },
      {
        ...
        date: "2024",
        description: "UNESCO Tentative List streets that preserve our colonial heritage"
      }
    ]
  },
  "daily-life": {
    ...
    featured: false,
    culturalContext: "Daily life on Brava follows rhythms set by weather, tides, and community bonds that have sustained us through centuries of challenge and change.",
    ...
    photos: [
      {
        ...
        date: "2024",
        description: "The daily ritual of bringing mountain-grown produce to our neighbors"
      },
      {
        ...
        location: "Nova Sintra",
        date: "2024",
        description: "Our central square remains the heart of community life, as it has for generations"
      },
      {
        ...
        date: "2024",
        description: "The wisdom of elders passed down through daily conversations"
      },
      {
  ...
  "flora-fauna": {
    ...
    featured: false,
    culturalContext: "Brava's nickname 'Ilha das Flores' comes from our year-round blooms, sustained by Atlantic mists that keep our island green when others are dry.",
    ...
    photos: [
      {
        ...
        location: "Nova Sintra",
        date: "2024",
        description: "The purple blossoms that brighten every neighborhood corner"
      },
      {
        ...
        date: "2024",
        description: "Our native birds of prey, found nowhere else in the world"
      },
      {
        ...
        date: "2024",
        description: "Native plants our ancestors used for healing, still treasured today"
      },
      {
        ...
        date: "2024",
        description: "Morning mist nurtures the flowers that give our island its gentle beauty"
      }
    ]
  }
};
