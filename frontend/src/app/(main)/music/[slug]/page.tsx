...
const categoryPages = pages.filter((p) => p.category === "music");
...
export async function generateMetadata({
  ...
  return {
    title: `${page.title} | Music | Nos Ilha`,
...
export default async function MusicPage({ params, searchParams }: PageProps) {
  const { slug } = await params;
