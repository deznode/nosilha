      ...
      <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <section className="mt-16">
          ...
          <div className="grid gap-8 md:grid-cols-2">
            {featuredTowns.map((town) => (
              <div key={town.slug} className="bg-white rounded-lg shadow-sm overflow-hidden hover:shadow-md transition-shadow">
                ...
                <div className="p-6">
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-4 text-sm">
                    <div className="flex items-center text-volcanic-gray">
                  ...
                  <div className="mb-4">
                    <p className="text-sm font-medium text-volcanic-gray-dark mb-2">Highlights:</p>
        ...
        <section className="mt-16">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            {otherTowns.map((town) => (
              <div key={town.slug} className="bg-white p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow">
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center space-x-4 text-xs text-volcanic-gray mb-2">
