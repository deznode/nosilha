      ...
      <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <section className="mt-16 bg-white p-8 rounded-lg shadow-sm">
          ...
          <div className="space-y-6">
            <div>
              ...
              <ul className="space-y-2 text-volcanic-gray ml-4">
          ...
          <div className="flex items-start mb-4">
            ...
            <div>
              ...
              <div className="space-y-4">
                <div>
                  <h4 className="font-semibold text-volcanic-gray-dark mb-2">Data Storage</h4>
                ...
                <div>
                  <h4 className="font-semibold text-volcanic-gray-dark mb-2">Security Measures</h4>
                  <ul className="text-volcanic-gray space-y-1 ml-4">
          ...
          <div className="flex items-start mb-4">
            ...
            <div>
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div>
                  <h4 className="font-semibold text-volcanic-gray-dark mb-2">Access & Control</h4>
                  <ul className="text-volcanic-gray space-y-1">
                ...
                <div>
                  <h4 className="font-semibold text-volcanic-gray-dark mb-2">Communication</h4>
                  <ul className="text-volcanic-gray space-y-1">
          ...
          <div className="space-y-4">
            ...
            <div className="grid gap-4 md:grid-cols-3">
              <div className="bg-off-white p-4 rounded">
                <h4 className="font-semibold text-volcanic-gray-dark mb-2">Essential Cookies</h4>
              ...
              <div className="bg-off-white p-4 rounded">
                <h4 className="font-semibold text-volcanic-gray-dark mb-2">Analytics Cookies</h4>
                <p className="text-sm text-volcanic-gray">
              ...
              <div className="bg-off-white p-4 rounded">
                <h4 className="font-semibold text-volcanic-gray-dark mb-2">Preference Cookies</h4>
                <p className="text-sm text-volcanic-gray">
        ...
        <section className="mt-16 bg-white p-8 rounded-lg shadow-sm">
          ...
          <div className="space-y-4">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <div>
                <h4 className="font-semibold text-volcanic-gray-dark mb-2">Authentication</h4>
              ...
              <div>
                <h4 className="font-semibold text-volcanic-gray-dark mb-2">Maps & Location</h4>
                <p className="text-sm text-volcanic-gray mb-2">
              ...
              <div>
                <h4 className="font-semibold text-volcanic-gray-dark mb-2">Cloud Storage</h4>
                <p className="text-sm text-volcanic-gray mb-2">
              ...
              <div>
                <h4 className="font-semibold text-volcanic-gray-dark mb-2">Analytics</h4>
                <p className="text-sm text-volcanic-gray mb-2">
        ...
        <section className="mt-16 bg-white p-8 rounded-lg shadow-sm">
          ...
          <div className="space-y-4">
            ...
            <p className="text-volcanic-gray mt-4">
