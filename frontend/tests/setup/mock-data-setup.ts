  ...
  return [
    {
      ...
      slug: "nova-sintra",
      description:
        "The charming capital of Brava Island, perched high in the mountains with stunning views and UNESCO World Heritage colonial architecture.",
    ...
    },
    {
      ...
      slug: "furna",
      description:
        "A historic fishing village nestled in a volcanic crater, home to Brava's main harbor and maritime traditions.",
    ...
    },
    {
      ...
      slug: "faja-de-agua",
      description:
        "A coastal paradise famous for its natural swimming pools and dramatic cliffs meeting the Atlantic Ocean.",
