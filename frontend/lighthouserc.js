  ...
  ci: {
    ...
    assert: {
      ...
      assertions: {
        ...
        'categories:accessibility': ['error', { minScore: 0.90 }], // High accessibility for diverse users
        'categories:best-practices': ['error', { minScore: 0.85 }],
        'categories:seo': ['error', { minScore: 0.90 }], // Critical for tourism discoverability
