...
export async function setupTestDatabase(): Promise<void> {
  ...
  if (!testDatabaseUrl) {
    console.log(
      "ℹ️ No test database configured - using API fallback to mock data"
    );
    return;
  }
  ...
  try {
    ...
    console.log(
      "🗄️ Test database setup - connecting to:",
  ...
  const testSeedData: TestDataSeed = {
    ...
    towns: [
      ...
      },
      {
        ...
        slug: "furna-test",
        description:
          "Historic fishing village in volcanic crater - test version",
