        ...
        headers: [
          ...
          // Content Security Policy - allows Mapbox, Google Analytics, Supabase, fonts
          {
            ...
            value: [
              ...
              "connect-src 'self' https://api.nosilha.com https://*.nosilha.com https://api.mapbox.com https://*.mapbox.com https://www.google-analytics.com https://analytics.google.com https://*.supabase.co wss://*.supabase.co https://www.clarity.ms https://*.clarity.ms",
