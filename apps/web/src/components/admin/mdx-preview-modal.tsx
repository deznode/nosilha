  ...
  return (
    <Dialog open={isOpen} onClose={onClose} size="5xl">
      ...
      <DialogBody>
        ...
        <div className="mb-6">
          {isSchemaValid ? (
            <div className="border-status-success-edge bg-status-success-surface flex items-center gap-2 rounded-lg border px-4 py-3">
              <CheckCircle className="text-status-success-ink h-5 w-5 flex-shrink-0" />
              <div className="flex-1">
                <p className="text-status-success-ink text-sm font-medium">
                  Schema compliance verified
                </p>
                <p className="text-status-success-ink text-xs">
