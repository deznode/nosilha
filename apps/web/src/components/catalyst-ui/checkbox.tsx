...
const base = [
  ...
  // Border
  "border border-basalt-900/15 group-data-checked:border-transparent group-data-hover:group-data-checked:border-transparent group-data-hover:border-basalt-900/30 group-data-checked:bg-(--checkbox-checked-border)",
  "dark:border-white/15 dark:group-data-checked:border-white/5 dark:group-data-hover:group-data-checked:border-white/5 dark:group-data-hover:border-white/30",
  // Inner highlight shadow
  "after:absolute after:inset-0 after:rounded-[calc(0.3125rem-1px)] after:shadow-[inset_0_1px_--theme(--color-white/15%)]",
  "dark:after:-inset-px dark:after:hidden dark:after:rounded-[0.3125rem] dark:group-data-checked:after:block",
  // Focus ring
  "group-data-focus:outline-2 group-data-focus:outline-offset-2 group-data-focus:outline-ocean-blue",
  // Disabled state
  "group-data-disabled:opacity-50",
  "group-data-disabled:border-basalt-900/25 group-data-disabled:bg-basalt-900/5 group-data-disabled:[--checkbox-check:var(--color-basalt-900)]/50 group-data-disabled:before:bg-transparent",
...
const colors = {
  "dark/zinc": [
    "[--checkbox-check:var(--color-white)] [--checkbox-checked-bg:var(--color-basalt-900)] [--checkbox-checked-border:var(--color-basalt-900)]/90",
    "dark:[--checkbox-checked-bg:var(--color-basalt-500)]",
  ],
  "dark/white": [
    "[--checkbox-check:var(--color-white)] [--checkbox-checked-bg:var(--color-basalt-900)] [--checkbox-checked-border:var(--color-basalt-900)]/90",
    "dark:[--checkbox-check:var(--color-basalt-900)] dark:[--checkbox-checked-bg:var(--color-white)] dark:[--checkbox-checked-border:var(--color-basalt-900)]/15",
  ],
  white:
    "[--checkbox-check:var(--color-basalt-900)] [--checkbox-checked-bg:var(--color-white)] [--checkbox-checked-border:var(--color-basalt-900)]/15",
  dark: "[--checkbox-check:var(--color-white)] [--checkbox-checked-bg:var(--color-basalt-900)] [--checkbox-checked-border:var(--color-basalt-900)]/90",
  zinc: "[--checkbox-check:var(--color-white)] [--checkbox-checked-bg:var(--color-basalt-500)] [--checkbox-checked-border:var(--color-basalt-800)]/90",
  ...
  yellow:
    "[--checkbox-check:var(--color-white)] [--checkbox-checked-bg:var(--color-sobrado-ochre)] [--checkbox-checked-border:var(--color-sobrado-ochre)]/80",
  ...
  blue: "[--checkbox-check:var(--color-white)] [--checkbox-checked-bg:var(--color-ocean-blue)] [--checkbox-checked-border:var(--color-ocean-blue)]/90",
  indigo:
