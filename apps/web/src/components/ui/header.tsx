...
export function Header({
  ...
  return (
    <Disclosure
      as="nav"
      className={clsx(
        "border-edge bg-canvas sticky top-0 z-50 border-b shadow-subtle",
        className
      )}
                            ...
                            <>
                              ...
                              >
                                <PopoverPanel className="absolute left-1/2 z-10 mt-3 w-screen max-w-xs -translate-x-1/2 transform px-2 sm:px-0">
                                  <div className="overflow-hidden rounded-button shadow-elevated ring-1 ring-black/5">
              ...
              <div className="flex items-center space-x-2 md:space-x-3">
                <div className="hidden items-center space-x-2 md:flex">
                  ...
                  <Menu as="div" className="relative">
                    ...
                    <MenuItems className="bg-canvas absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md py-1 shadow-elevated ring-1 ring-black/5 focus:outline-none">
                      {languages.map((lang) => (
                  ...
                  {session ? (
                    <Menu as="div" className="relative ml-2">
                      ...
                      <MenuItems className="divide-hairline bg-canvas absolute right-0 z-10 mt-2 w-56 origin-top-right divide-y rounded-md py-1 shadow-elevated ring-1 ring-black/5 focus:outline-none">
