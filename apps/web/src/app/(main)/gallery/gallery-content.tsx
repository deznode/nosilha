...
export function GalleryContent({
  ...
  return (
    <div className="bg-canvas min-h-screen pb-12">
      ...
      {/* Sticky Toolbar */}
      <div
        className="border-hairline bg-canvas shadow-subtle sticky top-[var(--nav-offset,64px)] z-30 border-b transition-[top] duration-300"
