...
const _PEOPLE_PAGE_CONTENT_ID = "66666666-7777-4888-8faf-999999999999";
                          ...
                          >
                            {(figure.featured
                              ...
                              <li key={index} className="flex items-start">
                                <Star className="text-sunny-yellow mt-0.5 mr-2 h-3 w-3 flex-shrink-0" />
                                <span
          ...
          <section className="mt-16">
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
              <div className="from-ocean-blue/10 to-ocean-blue/5 border-ocean-blue/20 rounded-lg border bg-gradient-to-br p-6 text-center shadow-sm">
                <Music className="text-ocean-blue mx-auto mb-3 h-10 w-10" />
