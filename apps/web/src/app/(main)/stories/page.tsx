        ...
        <div className="mx-auto max-w-7xl px-4 py-5 sm:px-6 sm:py-12 lg:px-8">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
            ...
            <Link
              ...
              className="bg-ocean-blue hover:bg-ocean-blue/90 rounded-button shadow-subtle focus-visible:ring-ocean-blue flex shrink-0 items-center gap-2 px-5 py-2.5 text-sm font-bold text-white transition-all focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-none active:scale-95"
            >
