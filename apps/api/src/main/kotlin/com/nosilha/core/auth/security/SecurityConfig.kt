        ...
        http
            ...
            .authorizeHttpRequests { requests ->
                requests
                    ...
                    .permitAll()
                    // Archive counts and located-photograph sequence (spec 034 FR-018, FR-021)
                    .requestMatchers(HttpMethod.GET, "/api/v1/gallery/facets")
                    .permitAll()
                    .requestMatchers(HttpMethod.GET, "/api/v1/gallery/{id}/sequence")
                    .permitAll()
                    ...
                    .permitAll()
                    .requestMatchers(HttpMethod.GET, "/api/v1/gallery/random")
                    .permitAll()
                    .requestMatchers(HttpMethod.GET, "/api/v1/gallery/featured")
                    .permitAll()
                    .requestMatchers(HttpMethod.GET, "/api/v1/gallery/weekly")
                    .permitAll()
                    .requestMatchers(HttpMethod.GET, "/api/v1/gallery/timeline")
                    .permitAll()
