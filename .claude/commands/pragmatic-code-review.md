...
1. **Save the report** to: `plan/code-review/{YYYY-MM-DD}_{HH-MM-SS}_pragmatic-code-review.md`
...
2. **Display the full report** to the user in the chat

3. **Confirm the save**: "✅ Report saved to: plan/code-review/{filename}"

4. **Content Guidelines**: Provide specific, actionable feedback. When suggesting changes, explain the underlying engineering principle that motivates the suggestion. Be constructive and concise.