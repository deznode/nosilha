...
Architecture Decision Records (ADRs) document significant technical decisions made during the development of Nos Ilha. Each ADR captures the context, options considered, decision rationale, and consequences.
...
Use the [template](template.md) to create new ADRs. Follow MADR (Markdown Any Decision Records) format.

**Naming Convention**: `NNNN-title-with-dashes.md` (e.g., `0004-caching-strategy.md`)
