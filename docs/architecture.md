...
- **Backend**: Spring Boot 4.0.0 with Kotlin 2.3.0, Java 25, and domain-driven design
...
- **Frontend**: `components/auth/auth-form.tsx` handles user input
...
│   │   │   │   └── [category]/[slug]/page.tsx  # Entry details
...
│   │   └── features/map/            # Mapbox GL map integration
...
├── gallery/        # Gallery Module - Media assets & storage, provides MediaQueryService
...
**Key Points:**
- See `docs/spring-modulith.md` for detailed module architecture
...
2. **Security Scanning Integration**
   ...
   - **ktlint**: Kotlin code style (detekt temporarily disabled pending Kotlin 2.3.0 compatibility)
...
- **Dependencies**: Spring Modulith 2.0.1 configured in `build.gradle.kts`
...
**Architecture**: Comprehensive testing across all layers with Playwright and Vitest
