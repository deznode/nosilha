...
**Note**: This project follows Spring Modulith modular architecture with enforced module boundaries. See [`spring-modulith.md`](spring-modulith.md) for comprehensive module documentation.
